...
= the task id; **V10** (owner riders from `deferred.md`): `http_budget`→`call_budget`, delete dead `RunPane`/`JourneyPane`. **Tier 4** — table renames + a public-API path change (`/api/v1/tasks`,
...
lifecycle IA) and retires ADR 0031 decision 2 (the screen/code split). Ten
numbered defects V1–V10 and the owner forks F1–F5 are in
