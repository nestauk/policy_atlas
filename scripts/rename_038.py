...
NEVER_MAPPED: dict[str, frozenset[int]] = {
    ...
    # Dead export removed by hand before the phase-4 apply (plan D4): the
    # real create path is `useCreateTask`, and the name must be free for
    # `useCreatePortfolio` → `useCreateProject`.
