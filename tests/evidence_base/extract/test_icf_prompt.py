...
from policy_atlas.evidence_base.extract.extract import _icf_judge_payload_entry
...
from policy_atlas.evidence_base.extract.icf_prompt import (
...
from policy_atlas.evidence_base.extract.iof_prompt import envelope_json
...
def test_few_shot_preflight_binding() -> None:
    ...
    import policy_atlas.evidence_base.extract.icf_prompt as icp
