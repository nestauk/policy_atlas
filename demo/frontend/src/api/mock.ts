...
function script(): Step[] {
  return [
    ...
    { delay: 1200, event: { type: 'artefact.skeleton', data: { sections: [
      { title: 'Key findings', focus: "The report's headline claims.", role: 'key_findings' },
      { title: 'What works in schools', focus: 'School-based interventions and their effects.', role: 'standard' },
      { title: 'Food environment and pricing', focus: 'Population-level levers beyond the school gate.', role: 'standard' },
      { title: 'Conclusions', focus: 'What the evidence adds up to.', role: 'conclusions' },
    ] } } },
    { delay: 800, event: { type: 'artefact.section_started', data: { index: 0, title: 'What works in schools' } } },
    { delay: 2400, event: { type: 'artefact.section_completed', data: { index: 0, title: 'What works in schools', content: 'School-based programmes combining diet and activity show modest but consistent effects on BMI in primary-age children. Effects fade without reinforcement beyond the school day.' } } },
    { delay: 500, event: { type: 'artefact.section_started', data: { index: 1, title: 'Food environment and pricing' } } },
    { delay: 2200, event: { type: 'artefact.section_completed', data: { index: 1, title: 'Food environment and pricing', content: 'Fiscal measures — notably the soft drinks industry levy — shifted reformulation at scale. Evidence on planning restrictions near schools is thinner and largely observational.' } } },
    { delay: 400, event: { type: 'artefact.section_started', data: { index: 2, title: 'Conclusions' } } },
    { delay: 1800, event: { type: 'artefact.section_completed', data: { index: 2, title: 'Conclusions', content: 'The strongest evidence supports combined school and fiscal approaches; single-setting interventions underperform.' } } },
    { delay: 400, event: { type: 'artefact.section_completed', data: { index: -1, title: 'Key findings', content: 'Combined diet-and-activity school programmes work modestly; fiscal levers drive reformulation; no single-setting intervention is sufficient alone.' } } },
    { delay: 600, event: completed('synthesise', 'Writing the evidence base', { section_count: 3, seconds: 39 }), funnel: { cited: 8 } },
