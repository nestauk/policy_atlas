...
function script(): Step[] {
  return [
    ...
    { delay: 700, event: started('screen', 'Screening for relevance', 'Every title and abstract, against your question') },
    ...[40, 87, 139, 188, 214].map((_n, i) => ({
      delay: 1300,
      event: p('screen', 'tick', { note: 'Screening sources against your question' }),
