...
surfaces live in :mod:`policy_atlas.evidence_base.synthesis.synthesis_backend` and
:mod:`policy_atlas.evidence_base.synthesis.grounding_judge`; nothing in this module composes prose.
