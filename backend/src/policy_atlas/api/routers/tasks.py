...
def update_task(
    ...
    **colleague-mutation** grade (owner ∪ same-org org-visible, never the
    ...
    if "visibility" in changes:
        ...
        # answers are "change the Task's visibility" and "leave the Task
        # out of the Task" — never a silent write that the cascade would
    ...
    if "project_ids" in changes:
        ...
        # org-visible row inside a private Task. Both paths lock the
