...
def test_task_card_claims_recovers_from_colliding_aliases() -> None:
    ...
    projected = repository._task_card_claims(raw_card_a, block_claim_by_id)
...
def test_task_card_claims_keeps_alias_hits_when_text_matches() -> None:
    ...
    projected = repository._task_card_claims(
