...
from policy_atlas.evidence_base.extract.relevance_annotator import validate_annotation_coverage
...
from tests.helpers import profile_doc, seed_project_and_run, seed_scope
...
def test_hostile_finding_with_out_of_enum_mark_fails_open(conn: Connection) -> None:
    ...
    _, _cid, findings = _seed_hostile_finding_doc(conn, project_id, sel_run, scope_id)
