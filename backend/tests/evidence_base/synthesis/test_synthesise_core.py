...
def test_characterisation_only_stub_writes_substrate_and_rollup(conn: Connection) -> None:
    ...
    assert row.synthesis_provenance["prompt_versions"]["sections"] == "synthesise_sections_v3"
...
def test_text_basis_matches_across_both_retrieval_paths(conn: Connection) -> None:
    ...
    from policy_atlas.evidence_base.synthesis.synthesis_tools import build_retrieval_scope
