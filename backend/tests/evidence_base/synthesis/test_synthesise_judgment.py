...
def _empty_substrate() -> Any:
    from policy_atlas.evidence_base.synthesis.synthesise import CorpusProfile, SubstrateView
...
def test_reasoning_over_cap() -> None:
    from policy_atlas.evidence_base.synthesis.synthesise import validate_claims
