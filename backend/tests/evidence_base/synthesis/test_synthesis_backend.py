...
from policy_atlas.evidence_base.synthesis.synthesis_tools import ToolExchange, run_section_loop
...
def test_salvage_section_rejects_missing_and_oversized_prose() -> None:
    ...
    from policy_atlas.evidence_base.synthesis.synthesis_backend import SECTION_PROSE_MAX
    from policy_atlas.evidence_base.synthesis.synthesis_tools import MalformedEmissionError
