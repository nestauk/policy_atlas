...
from policy_atlas.evidence_search.extract.extract import _icf_judge_payload_entry
...
from policy_atlas.evidence_search.extract.iof_prompt import envelope_json
...
def test_few_shot_preflight_binding() -> None:
    ...
    import policy_atlas.evidence_search.extract.icf_prompt as icp
