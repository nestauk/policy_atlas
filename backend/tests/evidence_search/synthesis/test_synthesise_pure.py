...
def _substrate() -> SubstrateView:
    ...
    return SubstrateView(
        ...
        chunks_by_tss_id={"tss-1": [chunk], "tss-2": [unappraised]},
...
def test_doc_record_default_metadata_present_and_absent() -> None:
    present = SimpleNamespace(
        tss_id="11111111-1111-1111-1111-111111111111",
        origin="uploaded",
    ...
    absent = SimpleNamespace(
        tss_id="22222222-2222-2222-2222-222222222222",
        origin="uploaded",
...
def test_finding_record_default_metadata_present_and_absent() -> None:
    present = SimpleNamespace(
        ...
        task_source_snapshot_id="11111111-1111-1111-1111-111111111111",
        intervention="A",
        outcome="B",
        population=None,
        setting="clinic",
    ...
    absent = SimpleNamespace(
        ...
        task_source_snapshot_id="22222222-2222-2222-2222-222222222222",
        intervention="A",
        outcome="B",
        population=None,
        setting=None,
