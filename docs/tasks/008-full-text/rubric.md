...
1. [ ] Implementation satisfies [contract.md](contract.md) (rev 3).
...
7. [ ] Known gaps and deferred seams listed in [docs/deferred.md](../../deferred.md):
       ...
       retry/backoff) · ML-layout parse-profile escalation (docling) · OCR for
       `no_text_layer` documents · vectorisation at the first
