...
`uuid5(NAMESPACE, f"{project_id}:{name}")`. Properties that matter:
...
- `backend/src/policy_atlas/evidence_base/corpus/characterise.py`
  (theme_id minting)
