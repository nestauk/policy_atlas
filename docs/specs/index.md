...
9. [vocabulary/policy-atlas-definitions.md](sources/vocabulary/policy-atlas-definitions.md) — the team's agreed definitions (2026-09-04): Capability · Component · Task · Project · Tabs · Artefact · Agent overlay · Links · Context. Input to task 038; the living glossary is `system/vocabulary.md`. Amended the same day by [policy-atlas-definitions-addendum-2026-09-04.md](sources/vocabulary/policy-atlas-definitions-addendum-2026-09-04.md) — the Agent tab, chats stay chats, the pinned **Task Agent** primary chat; the addendum wins on conflict.
