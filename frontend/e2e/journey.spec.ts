...
import { MOCK_CHAT_CLAIM_TEXT, MOCK_TASK_ID, mockCheckIn, mockTask } from "../src/mock/fixtures";
...
test.describe("mock task-lifecycle journey", () => {
  ...
  // succeed first, unlike the old evidence-search route, which was ungated.
