      ...
      >
        ...
        {thread.flatMap((item, index) => {
          ...
          return index === planCardAt - 1
            ? [rendered, <PlanCard key="plan-card" taskId={taskId} runActive={runActive} started={planStarted} isOwner={isOwner} onReviewPlan={onReviewPlan} overlay={planOverlay} onOverlayApplied={onOverlayApplied} onDiscardOverlay={onOverlayApplied} />]
            : [rendered];
        })}
