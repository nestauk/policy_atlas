              ...
              <>
                ...
                {runStatus === "failed" && (
                  <div role="alert" className="border-l-2 border-l-red bg-paper p-4 shadow-[0_1px_3px_rgba(15,41,74,0.05)]">
                    <p className="text-meta font-bold text-navy">The analysis failed.</p>
                    <p className="mt-1 text-caption text-grey">Whatever completed is kept and readable. You can start a fresh run.</p>
