...
import { addOpenChatTab, isPlanningConversation, taskAgentConversationId, useActiveConversation, useConversationMutations } from "./conversationState";
...
/** The Agent overlay: side-by-side chat on every task view (038 V8).
 *
